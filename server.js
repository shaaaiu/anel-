...
app.get('/api', (req, res) => {
  ...
  <style>body{font-family:sans-serif;background:#0b1020;color:#e6f1ff;padding:2rem}a{color:#61dafb}</style>
  </head><body>
  <h1>Panel Otomatis API</h1>
  <p>Lihat dokumentasi lengkap di <a href="/api-docs">/api-docs</a></p>
  <h2>Endpoints Utama</h2>
  <ul>
    <li>POST /api/order</li>
    <li>GET /api/order/:id/status</li>
    <li>DELETE /api/order/:id</li>
    <li>GET /health</li>
  </ul>
  </body></html>`);
});
